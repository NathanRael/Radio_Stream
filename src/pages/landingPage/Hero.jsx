...
const Hero = () => {
  ...
  return (
    <section className={` flex flex-col gap-12 max-md:gap-10 items-center justify-center mt-[120px]  max-w-[866px] mx-auto max-md:px-4 normal-transition delay-[3000ms]`}>
      <div className="" id="Hero">
        <img src={soundWave} alt="" />
      </div>
      <div className="flex flex-col justify-center items-center gap-6">
        <p className="text-black text-title-1 max-md:text-subtitle-1 font-FuturaBold text-center">
          Ecouter la radio de l'université de Fianarantsoa.
        </p>
        <p className="text-lead text-black-60 text-center">
      ...
      <div className="flex items-center justify-evenly w-full flex-row max-md:flex-col max-md:gap-y-4">
        ...
        <ButtonLg text="Acceder à l'application" color="bg-black-10"/>
      </div>
    </section>
  );
};
